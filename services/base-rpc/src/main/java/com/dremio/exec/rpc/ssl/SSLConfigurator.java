...
public class SSLConfigurator {
  ...
  public Optional<SSLConfig> getSSLConfig(
    ...
    return getSSLConfig(disablePeerVerification, false, hostName, alternativeHostNames);
  }
   ...
   *
   * @param disablePeerVerification disable peer verification
   * @param disableHostVerification disable host verification
   * @param hostName host name of this service
   * @param alternativeHostNames alternative host names of this service
   * @return ssl config
   */
  public Optional<SSLConfig> getSSLConfig(
    ...
    builder.setDisableHostVerification(disableHostVerification);
